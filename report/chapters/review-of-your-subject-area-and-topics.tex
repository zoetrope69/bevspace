...
\colorbox{pink}{TODO: describe a homebrew process} % describe a home brew process?
...
60 frames per second is the goal to hit when animating on the web. % cite why? \ref{high_performance_animations}

There is a term called `jank' when a page is lagging blah blah % cite
...
\colorbox{pink}{TODO: RAIL} % https://www.smashingmagazine.com/2015/10/rail-user-centric-model-performance/ \cite{introducing_RAIL}
\colorbox{pink}{TODO: FLIP} % https://aerotwist.com/blog/flip-your-animations/ \cite{FLIP}
